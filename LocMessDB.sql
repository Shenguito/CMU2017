...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS 'LocMessDB'.'users' (
...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS 'LocMessDB'.'profiles' (
...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS 'LocMessDB'.'locations' (
...
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS 'LocMessDB'.'messages' (
	...
	CONSTRAINT 'location_name'
		...
		REFERENCES 'LocMessDB'.'locations' ('location_name')
		ON DELETE NO ACTION
		ON UPDATE NO ACTION,
	CONSTRAINT 'username'
		FOREIGN KEY ('username')
		REFERENCES 'LocMessDB'.'username' ('username')
		ON DELETE NO ACTION
		ON UPDATE NO ACTION)
ENGINE = InnoDB
